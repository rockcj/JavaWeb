...
public interface TimeTableService {
    ...
    // 根据教师ID和学期查询课表
    List<TimeTable> queryTimeTableByTeacherAndSemester(String teacherId, String semester);
    ...
    // 根据教师ID和时间段查询冲突
    List<TimeTable> queryTimeConflictByTeacher(String teacherId, String dayOfWeek, String timeSlot, String semester);
}