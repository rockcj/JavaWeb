...
<form >
    ...
    <button type="button" class="add-row-btn" onclick="addJobRow()">+ 添加空白行</button>
    <br><br>
    <button type="submit" class="submit-btn" onclick="insertJob(event)">提交</button>
</form>
