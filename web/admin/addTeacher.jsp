...
<form >
    ...
    <button type="button" class="add-row-btn" onclick="addTeacherRow()">+ 添加空白行</button>
    <br><br>
    <button type="submit" class="submit-btn" onclick="insertTeacher(event)">提交</button>
</form>
