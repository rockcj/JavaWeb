...
<table>
    <tr>
        ...
        <th>职称</th>
        <th>状态标志</th>
        <th><input type="submit" value="批量删除" onclick="delcheckSingle('../teacher/delete','teacherId');"></th>
    </tr>
    <%
    ...
    <tr>
        <td><input type="checkbox" name="check" value="<%=teacher.getTeacherId()%>"></td>
        ...
        <td>
            ...
            <a href="../teacher/delete?teacherId=<%=teacher.getTeacherId()%>"
